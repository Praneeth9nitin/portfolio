    ...
    projects:[
        {
            img:project1,
            title:"fruit Soda",
            description:"An applications with only for showing animation skills using gsap",
        ...
        },
        {
            img:project2,
            title:"Payment app",
            description:"Dummy payment website developed to sharpen my full stack skills",
            git:"https://github.com/Praneeth9nitin/MyFirstRepository",
        },
        {
            img:project3,
            title:"Blogging app",   
            description:"Blogging site in which user can create, read and publish their blogs",
            git:"https://github.com/Praneeth9nitin/Blogging",
        },
    ]
}
        
export { nav, about, skills, projects }