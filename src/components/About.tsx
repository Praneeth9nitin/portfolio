...
function About() {
  ...
  return (
    <div className='bg-back text-white font-family md:p-20 p-10 grid grid-row-3 grid-cols-3'>
        ...
        <div id='about3' className='about md:col-span-2 col-span-3 text-slate-400 md:text-lg'>{about}</div>
    </div>
  )
}
